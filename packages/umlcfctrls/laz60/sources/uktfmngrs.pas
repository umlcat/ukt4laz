...
type
  ...
  TDOSColorPair = record
    Color:    TColor;
    DOSColor: uktdoscolors.doscolor;
  end;
  ...
  protected
    ...
    FDefaultDOSColor: uktdoscolors.doscolor;
    FDefaultDOSFontColor: uktdoscolors.doscolor;

    FFocusedDOSColor: uktdoscolors.doscolor;
    FFocusedDOSFontColor: uktdoscolors.doscolor;

    FDisabledDOSColor: uktdoscolors.doscolor;
    FDisabledDOSFontColor: uktdoscolors.doscolor;

    FReadOnlyDOSColor: uktdoscolors.doscolor;
    FReadOnlyDOSFontColor: uktdoscolors.doscolor;
  protected
    (* Protected declarations *)

    (* Accesors declarations *)

    procedure setDefaultColor(AValue: uktdoscolors.doscolor);
    procedure setDefaultFontColor(AValue: uktdoscolors.doscolor);

    procedure setFocusedColor(AValue: uktdoscolors.doscolor);
    procedure setFocusedFontColor(AValue: uktdoscolors.doscolor);

    procedure setDisabledColor(AValue: uktdoscolors.doscolor);
    procedure setDisabledFontColor(AValue: uktdoscolors.doscolor);

    procedure setReadOnlyColor(AValue: uktdoscolors.doscolor);
    procedure setReadOnlyFontColor(AValue: uktdoscolors.doscolor);
  public
    (* Public declarations *)
  ...
  public
    ...
    property DefaultColor: uktdoscolors.doscolor
      read FDefaultDOSColor write setDefaultColor;
    property DefaultFontColor: uktdoscolors.doscolor
      read FDefaultDOSFontColor write setDefaultFontColor;

    property FocusedColor: uktdoscolors.doscolor
      read FFocusedDOSColor write setFocusedColor;
    property FocusedFontColor: uktdoscolors.doscolor
      read FFocusedDOSFontColor write setFocusedFontColor;

    property DisabledColor: uktdoscolors.doscolor
      read FDisabledDOSColor write setDisabledColor;
    property DisabledFontColor: uktdoscolors.doscolor
      read FDisabledDOSFontColor write setDisabledFontColor;

    property ReadOnlyColor: uktdoscolors.doscolor
      read FReadOnlyDOSColor write setReadOnlyColor;
    property ReadOnlyFontColor: uktdoscolors.doscolor
...
begin
  ...
  begin
    ...
    ADOSPair.Color    := uktdoscolors.DOSColorToColor(AValue);
